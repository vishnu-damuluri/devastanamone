...
<body class=" " style="background-color: #c3a374;" >
...
<header class="  fixed top-0 w-screen z-10" style="background-color: #f2e7bf;">
    ...
    <div class="flex lg:flex">
        <a class="flex items-center ml-4 text-l font-bold leading-6 text-black" href="index.php">
          <div class="flex">
           ...
           <P class="px-2"> Pallikondeswara swamy devastanam </P>
        </a>
      </div>
      ...
      <a href="darshan.html" class="flex items-center text-md font-semibold leading-2 text-grey border-l border-r border-gray-500 px-2">Darshan</a>
        ...
        <a href="https://forms.gle/iwBKHyVHWvwXgWm37" class="flex items-center text-md font-semibold leading-2 text-grey border-l border-r border-gray-500 px-2">Donate </a>
      </div>
    </nav>
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              ...
              <a href="https://forms.gle/iwBKHyVHWvwXgWm37" class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10">Donate</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
    ...
    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 text-black lg:gap-x-8 lg:px-8">
      ...
      <div id="moreContent" style="display: none;">
        ...
        <br>
        <a class="my-4 py-4 text-lg font-bold">Telugu</a>
        <br>
        <a class="my-8 ">
          శ్రీ పల్లికొండేశ్వర స్వామి ఆలయము 1344వ సంవత్సరము శ్రీ హరి హర బుగ్గరాయులు కాలములో నిర్మించడము జరిగినది. అమృతం కోసం దేవతలు, రాక్షసులు కలిసి మందర పర్వతం, వాసుకి అనే సర్పం సాయంతో క్షీరసాగర మదనానికి పూనుకున్నారు, పాల సముద్రాన్ని చిలికే సమయంలో బయంకరమైన కాలకూట విషం బయటపడింది. పద్నాలుగు లోకాలు దహించడానికి సిద్దమైన ఆ కూలకూట విష ప్రభావం నుంచి రక్షించమని సుర, అసురులు బోళా శంకరుడైన పరమ శివుని ప్రార్ధిస్తారు. చతుర్దశ భువన పాలకుడైన మహేశ్వరుడు వారికి అభయమిచ్చి ఆ కాలకూట విషాన్ని చేతబూని అమాంతంగా మింగివేస్తాడు. ఆ హాలహలం శివుని గర్భంలోనికి పోనివ్వకుండా పార్వతీ దేవి శివుని కంఠం పట్టుకోగా, ఆ విషం కంఠం వద్దే నిలిచిపోయి స్వామిని నీలకంఠుణ్ణి చేసింది. భయంకరమైన ఈ కాలకూట విషం మహా శక్తివంతుడైన పరమశివుని సైతం కాసేపు మత్తెక్కిస్తుంది. విషప్రభావానికి లోనైన శివుడు మైకంతో కాసేపు ఈ క్షేత్రంలో విశ్రమించాడని, శివుడు శయనించిన క్షేత్రం గనుక దీనిని`శివ శయన క్షేత్రం`అంటారని స్కంద పురాణం ద్వారా తెలుస్తోంది. శివుడు హాలాహలం భక్షించి విశ్రమించినందున దీనిని `కాల కూటాసయన క్షేత్రం` అని క