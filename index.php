...
<body class=" " style="background-color: #de9c63;" >
...
<header class="  fixed top-0 w-screen z-10" style="background-color: #f2e7bf;">
    <nav class="mx-auto flex max-w-pc items-center justify-between p-4 lg:px-8" aria-label="Global">
      ...
      <a href="darshan.html" class="flex items-center text-md font-semibold leading-2 text-grey border-l border-r border-gray-500 px-2">Darshan</a>
        ...
        <a href="https://forms.gle/iwBKHyVHWvwXgWm37" class="flex items-center text-sm font-semibold leading-2 text-grey border-l border-r border-gray-500 px-2">Donate </a>
      </div>
    </nav>
